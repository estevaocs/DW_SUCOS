...
GO
PRINT N'A operação de refatoração Renomear com chave ab741723-8201-4747-a434-080404b18687 foi ignorada; o elemento [dbo].[Dim_Fabrica].[Id] (SqlSimpleColumn) não será renomeado para Cod_Fabrica';
